...
map.on('load', function () {
    ...
    map.on("click", "countries", function(e) {
        ...
        if(e.features[0].properties.iso_a2 in countryArray){       
            ...
            .setHTML('<body bgcolor="#def28d"/> <iframe src="https://open.spotify.com/embed?uri=spotify:track:'+countryArray[e.features[0].properties.iso_a2].link+'"width="300" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>')
            .addTo(map);
        }else{
            popup.setLngLat(e.lngLat)
